...
class Config:                                                                   
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "5676877386:AAHARA3jUG9nNTd7dt_mpKrz_z1Lb3vz0Tg")
    ...
    COLLECTION_NAME = os.environ.get('COLLECTION_NAME', 'Data1')
    ...
    TO_CHANNEL = int(os.environ.get("TO_CHANNEL", "-1001974954587"))
    BOT_USERNAME= os.environ.get("BOT_USERNAME", "Disjsjs_bot")
